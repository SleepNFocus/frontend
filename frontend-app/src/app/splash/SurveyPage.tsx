...
export const SurveyPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // null 체크 추가
      if (!gender || !birthYear || !mbti || !cognitiveType || !workTimePattern) {
  ...
  return (
    <Layout showNavbar={false}>
      <View style={styles.container}>
        ...
        <Text variant="titleMedium" style={styles.label}>인지 유형</Text>
        <CustomDropdown items={COGNITIVE_TYPE_OPTIONS} value={cognitiveType} onSelect={setCognitiveType} placeholder="인지 유형을 선택하세요" />

        <Text variant="titleMedium" style={styles.label}>근무 시간 패턴</Text>
        <CustomDropdown items={WORK_TIME_OPTIONS} value={workTimePattern} onSelect={setWorkTimePattern} placeholder="근무 시간 패턴을 선택하세요" />
